...
\xrightarrow[]{L_2=L_2-(-\frac{1}{5})L_1}
\begin{pmatrix}5 & -1 & 10\\ &-\frac{4}{25}  &\frac{8}{5} \\ 3 & 4 & 2\end{pmatrix}
\end{equation*}

\begin{equation}
    \left\{\begin{matrix} 5x-y=10\\-\frac{4}{25}y=\frac{8}{5} \\ 3x+4y=2 \end{matrix}\right.
\end{equation}
 \\ 
